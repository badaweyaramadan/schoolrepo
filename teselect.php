...
<br/>
 ...
 ser : <?php echo "$row[te_id]"."   "?>    


<br/>

  name: <?php echo "$row[te_name]"."   "?> 

<br/>

  subject:  <?php echo "$row[te_subject]"."<hr>"?> 
 
 <br/>

  class: <?php echo "$row[te_class]"."   "?>
...
<br/>
  ...
  <br/>
    ...
    <a href="teupdate.php" > <input type="submit" value="update" > </a>
 
 <a href="tedelete.php"> <input type="submit" value="delete" /></a>
